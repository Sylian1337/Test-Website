...
import VisualStudioGuide from '/src/assets/Selecting-C++-Desktop.png';
import BoostGuide from '/src/assets/Setting-Boost-In-Variables.png';
import HeidiSQLGuide from '/src/assets/HeidiSQL-First-Image.png';
